...
export default function TypographySample() {
    return (
        <View style={{ flex: 1, justifyContent: "center", alignItems: "center" }}>
          ...
          <Typography fontFamily='OpenSans-RegularItalic'>OpenSans Regular</Typography>
          <Typography fontFamily='OpenSans-Medium'>OpenSans Medium</Typography>
          <Typography fontFamily='OpenSans-MediumItalic'>OpenSans Medium</Typography>
          ...
          <Typography fontFamily='Poppins-RegularItalic'>Poppins Regular</Typography>
